...
const TopBar = (props) => {
  ...
  const loginTooltip = intl.formatMessage({
    id: "tooltip.logged",
    defaultMessage: "User",
  });
    ...
    <React.Fragment>
      ...
      >
        <Toolbar>
          ...
          {window.config.logoHorizontal && (
            <img
              alt="Logo"
              className={classes.logo}
              src={window.config.logoHorizontal}
            />
          )}
            ...
            {loginEnabled && loggedIn && (
              <Tooltip title={loginTooltip}>
                <IconButton color="inherit">
                  {myPicture ? (
                    <Avatar src={myPicture} className={classes.avatar} />
                  ) : (
                    <AccountCircle className={classes.green} />
                  )}
                </IconButton>
              </Tooltip>
            )}
